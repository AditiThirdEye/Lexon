...
#include "lexon-mlir-c/Dialects.h"
...
MLIR_DEFINE_CAPI_DIALECT_REGISTRATION(Bud, bud, lexon::bud::BudDialect)
MLIR_DEFINE_CAPI_DIALECT_REGISTRATION(DAP, dap, lexon::dap::DAPDialect)
MLIR_DEFINE_CAPI_DIALECT_REGISTRATION(DIP, dip, lexon::dip::DIPDialect)
MLIR_DEFINE_CAPI_DIALECT_REGISTRATION(Gemmini, gemmini,
                                      lexon::gemmini::GemminiDialect)
MLIR_DEFINE_CAPI_DIALECT_REGISTRATION(RVV, rvv, lexon::rvv::RVVDialect)
