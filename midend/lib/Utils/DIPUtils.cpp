...
//===----------------------------------------------------------------------===//
//
// This file implements DIP dialect specific utility functions for the lexon
// compiler ecosystem.
//
//===----------------------------------------------------------------------===//
...
void traverseImagewBoundaryExtrapolation(
    ...
    lexon::dip::BoundaryOption boundaryOptionAttr, int64_t stride, DIP_OP op) {
              ...
              builder.create<scf::IfOp>(
                  ...
                  [&](OpBuilder &builder, Location loc) {
                    ...
                    if (boundaryOptionAttr ==
                        lexon::dip::BoundaryOption::ConstantPadding) {
                      ...
                      builder.create<scf::IfOp>(
                          ...
                          [&](OpBuilder &builder, Location loc) {
                            ...
                            if (boundaryOptionAttr ==
                                lexon::dip::BoundaryOption::ReplicatePadding) {
