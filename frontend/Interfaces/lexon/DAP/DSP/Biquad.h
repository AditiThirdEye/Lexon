...
#ifndef FRONTEND_INTERFACES_LEXON_DAP_DSP_BIQUAD
#define FRONTEND_INTERFACES_LEXON_DAP_DSP_BIQUAD
...
void _mlir_ciface_lexon_biquad(MemRef<float, 1> *input,
...
void biquad(MemRef<float, N> *input, MemRef<T, N> *filter,
  ...
  detail::_mlir_ciface_lexon_biquad(input, filter, output);
}

} // namespace dap

#endif // FRONTEND_INTERFACES_LEXON_DAP_DSP_BIQUAD
