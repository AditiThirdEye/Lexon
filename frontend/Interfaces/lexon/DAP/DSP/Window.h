...
#ifndef FRONTEND_INTERFACES_LEXON_DAP_DSP_WINDOW
#define FRONTEND_INTERFACES_LEXON_DAP_DSP_WINDOW

#include "lexon/Core/Container.h"
#include "lexon/DAP/DSP/Math.h"
...
#endif // FRONTEND_INTERFACES_LEXON_DAP_DSP_WINDOW
