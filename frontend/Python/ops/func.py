...
# ===---------------------------------------------------------------------------
#
# The registry of mappings from Lexon node to MLIR func dialect operations.
#
# ===---------------------------------------------------------------------------
...
def func_op(node: FuncOp, symbol_table: Dict[Tuple[str, int], ir.Operation]):
    """
    Import the lexon FuncOp.
    From Lexon FuncOp to MLIR FUNC Func operation.
    """
    arguments = []
...
#     """
#     Import the lexon CallOp.
#     From Lexon CallOp to MLIR FUNC call operation.
#     """
#     arguments = []
...
def call_external_op(
    ...
    """
    Import the lexon CallExternalOp for external library calls (e.g., oneDNN).
    From Lexon CallExternalOp to MLIR FUNC call operation.
