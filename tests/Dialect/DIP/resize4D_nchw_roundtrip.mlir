...
func.func @lexon_resize4d_nchw_NEAREST_NEIGHBOUR_INTERPOLATION_f32(%input : memref<?x?x?x?xf32>, %horizontal_scaling_factor : f32, %vertical_scaling_factor : f32, %output : memref<?x?x?x?xf32>) -> () {
...
func.func @lexon_resize4d_nchw_NEAREST_NEIGHBOUR_INTERPOLATION_f64(%input : memref<?x?x?x?xf64>, %horizontal_scaling_factor : f32, %vertical_scaling_factor : f32, %output : memref<?x?x?x?xf64>) -> () {
...
func.func @lexon_resize4d_nchw_BILINEAR_INTERPOLATION_f32(%input : memref<?x?x?x?xf32>, %horizontal_scaling_factor : f32, %vertical_scaling_factor : f32, %output : memref<?x?x?x?xf32>) -> () {
...
func.func @lexon_resize4d_nchw_BILINEAR_INTERPOLATION_f64(%input : memref<?x?x?x?xf64>, %horizontal_scaling_factor : f32, %vertical_scaling_factor : f32, %output : memref<?x?x?x?xf64>) -> () {
