...
func.func @lexon_rotate4d_nhwc_f32(%inputImage : memref<?x?x?x?xf32>, %angle : f32, %outputImage : memref<?x?x?x?xf32>) -> () {
...
func.func @lexon_rotate4d_nhwc_f64(%inputImage : memref<?x?x?x?xf64>, %angle : f32, %outputImage : memref<?x?x?x?xf64>) -> () {
...
func.func @lexon_rotate4d_nhwc_i8(%inputImage : memref<?x?x?x?xi8>, %angle : f32, %outputImage : memref<?x?x?x?xi8>) -> () {
...
func.func @lexon_rotate4d_nhwc_i32(%inputImage : memref<?x?x?x?xi32>, %angle : f32, %outputImage : memref<?x?x?x?xi32>) -> () {
...
func.func @lexon_rotate4d_nhwc_i64(%inputImage : memref<?x?x?x?xi64>, %angle : f32, %outputImage : memref<?x?x?x?xi64>) -> () {
...
func.func @lexon_rotate4d_nchw_f32(%inputImage : memref<?x?x?x?xf32>, %angle : f32, %outputImage : memref<?x?x?x?xf32>) -> () {
...
func.func @lexon_rotate4d_nchw_f64(%inputImage : memref<?x?x?x?xf64>, %angle : f32, %outputImage : memref<?x?x?x?xf64>) -> () {
...
func.func @lexon_rotate4d_nchw_i8(%inputImage : memref<?x?x?x?xi8>, %angle : f32, %outputImage : memref<?x?x?x?xi8>) -> () {
...
func.func @lexon_rotate4d_nchw_i32(%inputImage : memref<?x?x?x?xi32>, %angle : f32, %outputImage : memref<?x?x?x?xi32>) -> () {
...
func.func @lexon_rotate4d_nchw_i64(%inputImage : memref<?x?x?x?xi64>, %angle : f32, %outputImage : memref<?x?x?x?xi64>) -> () {
