...
func.func @lexon_corr2d_CONSTANT_PADDING_f32(%input : memref<?x?xf32>, %identity : memref<?x?xf32>, %output : memref<?x?xf32>, %kernelAnchorX : index, %kernelAnchorY : index, %c : f32) -> () {
...
func.func @lexon_corr2d_CONSTANT_PADDING_f64(%input : memref<?x?xf64>, %identity : memref<?x?xf64>, %output : memref<?x?xf64>, %kernelAnchorX : index, %kernelAnchorY : index, %c : f64) -> () {
...
func.func @lexon_corr2d_CONSTANT_PADDING_i8(%input : memref<?x?xi8>, %identity : memref<?x?xi8>, %output : memref<?x?xi8>, %kernelAnchorX : index, %kernelAnchorY : index, %c : i8) -> () {
...
func.func @lexon_corr2d_CONSTANT_PADDING_i32(%input : memref<?x?xi32>, %identity : memref<?x?xi32>, %output : memref<?x?xi32>, %kernelAnchorX : index, %kernelAnchorY : index, %c : i32) -> () {
...
func.func @lexon_corr2d_CONSTANT_PADDING_i64(%input : memref<?x?xi64>, %identity : memref<?x?xi64>, %output : memref<?x?xi64>, %kernelAnchorX : index, %kernelAnchorY : index, %c : i64) -> () {
...
func.func @lexon_corr2d_REPLICATE_PADDING_f32(%input : memref<?x?xf32>, %identity : memref<?x?xf32>, %output : memref<?x?xf32>, %kernelAnchorX : index, %kernelAnchorY : index, %c : f32) -> () {
...
func.func @lexon_corr2d_REPLICATE_PADDING_f64(%input : memref<?x?xf64>, %identity : memref<?x?xf64>, %output : memref<?x?xf64>, %kernelAnchorX : index, %kernelAnchorY : index, %c : f64) -> () {
...
func.func @lexon_corr2d_REPLICATE_PADDING_i8(%input : memref<?x?xi8>, %identity : memref<?x?xi8>, %output : memref<?x?xi8>, %kernelAnchorX : index, %kernelAnchorY : index, %c : i8) -> () {
...
func.func @lexon_corr2d_REPLICATE_PADDING_i32(%input : memref<?x?xi32>, %identity : memref<?x?xi32>, %output : memref<?x?xi32>, %kernelAnchorX : index, %kernelAnchorY : index, %c : i32) -> () {
...
func.func @lexon_corr2d_REPLICATE_PADDING_i64(%input : memref<?x?xi64>, %identity : memref<?x?xi64>, %output : memref<?x?xi64>, %kernelAnchorX : index, %kernelAnchorY : index, %c : i64) -> () {
