...
func.func @lexon_resize2d_NEAREST_NEIGHBOUR_INTERPOLATION_f32(%input : memref<?x?xf32>, %horizontal_scaling_factor : f32, %vertical_scaling_factor : f32, %output : memref<?x?xf32>) -> () {
...
func.func @lexon_resize2d_NEAREST_NEIGHBOUR_INTERPOLATION_f64(%input : memref<?x?xf64>, %horizontal_scaling_factor : f32, %vertical_scaling_factor : f32, %output : memref<?x?xf64>) -> () {
...
func.func @lexon_resize2d_BILINEAR_INTERPOLATION_f32(%input : memref<?x?xf32>, %horizontal_scaling_factor : f32, %vertical_scaling_factor : f32, %output : memref<?x?xf32>) -> () {
...
func.func @lexon_resize2d_BILINEAR_INTERPOLATION_f64(%input : memref<?x?xf64>, %horizontal_scaling_factor : f32, %vertical_scaling_factor : f32, %output : memref<?x?xf64>) -> () {
