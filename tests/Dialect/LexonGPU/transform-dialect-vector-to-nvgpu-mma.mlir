// RUN: lexon-opt --split-input-file --transform-interpreter %s | FileCheck %s
...
module attributes { transform.with_named_sequence } {
  transform.named_sequence @__transform_main(
    ...
    transform.lexon.vector.vector_to_mma_conversion %func { use_wmma } : (!transform.any_op) -> ()
...
module attributes { transform.with_named_sequence } {
  transform.named_sequence @__transform_main(
    ...
    transform.lexon.vector.vector_to_mma_conversion %func { use_mma_sync } : (!transform.any_op) -> ()
