...
// RUN: lexon-text-container-test 2>&1 | FileCheck %s

#include <lexon/Core/Container.h>
#include <lexon/LLM/TextContainer.h>

using namespace lexon;

int main() {
  // The map of string-to-id used in the test cases:
  // lexon: 8937, compiler: 21624, is: 2003, a: 1037, domain: 5884
  ...
  //===--------------------------------------------------------------------===//
  std::string pureStr = "lexon compiler is a domain specific compiler";
  ...
  //===--------------------------------------------------------------------===//
  std::string puncStr = "lexon compiler: a domain specific compiler!";
  ...
  //===--------------------------------------------------------------------===//
  std::string cornerStr = "  lexon compiler : a domain specific compiler!!  ";
  ...
  //===--------------------------------------------------------------------===//
  std::string toLowerStr = "LEXON COMPILER IS A DOMAIN SPECIFIC COMPILER";
  ...
  //===--------------------------------------------------------------------===//
  std::string pureStrLlama = "lexon compiler is a domain specific compiler";
  ...
  // CHECK: lexon compiler is a domain specific compiler
  fprintf(stderr, "%s\n", pureStrLlamaResult.c_str());
  //===--------------------------------------------------------------------===//
  // Test text constructor for punctuation.
  //===--------------------------------------------------------------------===//
  std::string puncStrLlama = "lexon compiler: a domain specific compiler!";
  ...
  // CHECK: lexon compiler: a domain specific compiler!
