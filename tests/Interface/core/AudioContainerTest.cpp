...
// RUN: lexon-audio-container-test 2>&1 | FileCheck %s
...
int main() {
  // ---------------------------------------------------------------------------
  // 1. Print Decoded Reuslts using Lexon Audio Container
  // ---------------------------------------------------------------------------

  // Read and decode audio file with Lexon Audio Container.
  ...
  // ---------------------------------------------------------------------------
  // 2. Compare Encoded results using Lexon Audio Container and AudioFile.h
  // ---------------------------------------------------------------------------

  // Encode the audio data and save it to a file using the Lexon Audio Container
  string filePath = "./lexonEncodeResult.wav";
  aud.saveToFile(filePath, "WAVE");

  // Print metadata and sample values using the Lexon Audio Container.
