...
int main() {
  ...
  const std::string title = "Whisper Preprocess Powered by Lexon Compiler";
  ...
  Audio<double, 1> inputContainer("../../examples/LexonWhisper/audio.wav");
