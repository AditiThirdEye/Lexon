...
from lexon.compiler.graph.transform import (
    simply_fuse,
...
def main():
    ...
    # Import the model
    print("\nImporting model to Lexon Graph...")
    with torch.no_grad():
    ...
    # Save Lexon Graph before transform
    ...
    with open(os.path.join(output_dir, "graph.log"), "w") as graph_file:
        ...
        print("LEXON GRAPH BEFORE TRANSFORM", file=graph_file)
        print("=" * 80, file=graph_file)
    ...
    with open(
        ...
        print("LEXON GRAPH AFTER TRANSFORM", file=fused_file)
        print("=" * 80, file=fused_file)
