# Lexon Compiler Python Importer
## Introduction
This package serves as the PyTorch importer of Lexon Compiler. It is built on top of TorchDynamo, a Python-level JIT compiler introduced in PyTorch 2.0. Using this importer, one can convert a PyTorch function/model to corresponding MLIR code.
...
Build MLIR Python Binding in Lexon-MLIR.
...
For more demos, please refer to [examples/LexonPython](https://github.com/lexon-compiler/lexon-mlir/tree/main/examples/LexonPython). We currently offer two demos below.
