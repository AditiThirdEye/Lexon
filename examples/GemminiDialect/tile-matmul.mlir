...
func.func @main() -> i8 {
  ...
  %aArray = memref.alloc() : memref<64x64xi8>
  %bArray = memref.alloc() : memref<64x64xi8>
  %cArray = memref.alloc() : memref<64x64xi8>
  %dArray = memref.alloc() : memref<64x64xi32>
  ...
  gemmini.tile_matmul %aArray %bArray %cArray %dArray : memref<64x64xi8> memref<64x64xi8> memref<64x64xi8> memref <64x64xi32>
