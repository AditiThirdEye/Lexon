// RUN: lexon-opt -batchmatmul-optimize -verify-diagnostics -expand-strided-metadata -lower-affine -convert-vector-to-llvm \
...
// RUN: | mlir-runner -O0 -e lexon_batchmatmul_f32 -entry-point-result=void \
...
func.func @lexon_batchmatmul_f32(){
