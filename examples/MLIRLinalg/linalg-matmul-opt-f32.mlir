// RUN: lexon-opt -matmul-parallel-vectorization-optimize -verify-diagnostics -expand-strided-metadata -lower-affine \
...
// RUN: | mlir-runner -O0 -e lexon_matmul_f32 -entry-point-result=void \
