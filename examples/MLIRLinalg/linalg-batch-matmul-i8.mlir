// RUN: lexon-opt -batchmatmul-optimize -verify-diagnostics -expand-strided-metadata -lower-affine \
...
// RUN: | mlir-runner -O0 -e lexon_batchmatmul_i8 -entry-point-result=void \
...
func.func @lexon_batchmatmul_i8(){
