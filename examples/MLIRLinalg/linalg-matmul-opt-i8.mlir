// RUN: lexon-opt -matmul-parallel-vectorization-optimize -verify-diagnostics -expand-strided-metadata \
...
// RUN: | mlir-runner -O0 -e lexon_matmul_i8 -entry-point-result=void \
