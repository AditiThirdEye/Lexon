# Lexon Compiler WHISPER Example

## Introduction
This example shows how to use Lexon Compiler to compile a WHISPER model to MLIR code then run it.  The [model](https://huggingface.co/openai/whisper-base) is a pre-trained model for automatic speech recognition (ASR) and speech translation (ST).
...
```bash
$ cmake -G Ninja .. -DLEXON_WHISPER_EXAMPLES=ON
$ ninja lexon-whisper-run
$ cd bin
$ ./lexon-whisper-run
```
