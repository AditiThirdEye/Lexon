...
echo "========================================="
echo ""
echo "Lexon-MLIR Root: $LEXON_ROOT"
...
cd "$BUILD_DIR"
cmake .. -G Ninja \
  -DLEXON_TRANSFORMER_EXAMPLES=ON \
...
ninja lexon-transformer-timed-executable
echo "✓ Build completed"
echo ""

# Step 4: Copy parameters to build directory
echo "Copying parameters to build directory..."
cp "$SCRIPT_DIR/arg0.data" "$BUILD_DIR/examples/LexonTransformer/"
