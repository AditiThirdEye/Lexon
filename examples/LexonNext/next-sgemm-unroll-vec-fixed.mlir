    ...
    scf.parallel (%m_idx) = (%c0) to (%m) step (%unroll) {
      ...
      %n_iter_idx = scf.for %n_idx = %c0 to %n_body_bound step %step
        ...
        %sum_iter_vec_4, %sum_iter_vec_5, %sum_iter_vec_6, %sum_iter_vec_7
            ...
            %b_vec = vector.load %b[%k_idx, %n_idx] : memref<?x?xf32>, vector<32xf32>
        ...
        vector.store %sum_iter_vec_0, %c[%m_idx, %n_idx] : memref<?x?xf32>, vector<32xf32>
        vector.store %sum_iter_vec_1, %c[%m_idx_1, %n_idx] : memref<?x?xf32>, vector<32xf32>
        vector.store %sum_iter_vec_2, %c[%m_idx_2, %n_idx] : memref<?x?xf32>, vector<32xf32>
        vector.store %sum_iter_vec_3, %c[%m_idx_3, %n_idx] : memref<?x?xf32>, vector<32xf32>
        vector.store %sum_iter_vec_4, %c[%m_idx_4, %n_idx] : memref<?x?xf32>, vector<32xf32>
        vector.store %sum_iter_vec_5, %c[%m_idx_5, %n_idx] : memref<?x?xf32>, vector<32xf32>
        vector.store %sum_iter_vec_6, %c[%m_idx_6, %n_idx] : memref<?x?xf32>, vector<32xf32>
        vector.store %sum_iter_vec_7, %c[%m_idx_7, %n_idx] : memref<?x?xf32>, vector<32xf32>
