...
func.func @kernel(%arg0: tensor<8960x1536xf32>, %arg1: tensor<1024x1536xf32>, %arg2: tensor<8960x1536xf32>, %arg3: tensor<1536x8960xf32>, %arg4: tensor<1536xf32>, %arg5: tensor<1536x1536xf32>) -> tensor<1024x1536xf32> {
  ...
  %177 = linalg.matmul {cast = #linalg.type_fn<cast_signed>} ins(%arg1, %175 : tensor<1024x1536xf32>, tensor<1536x8960xf32>) outs(%cst_52 : tensor<1024x8960xf32>) -> tensor<1024x8960xf32>
  ...
  %184 = linalg.matmul {cast = #linalg.type_fn<cast_signed>} ins(%arg1, %182 : tensor<1024x1536xf32>, tensor<1536x8960xf32>) outs(%cst_53 : tensor<1024x8960xf32>) -> tensor<1024x8960xf32>
  ...
  %190 = linalg.matmul {cast = #linalg.type_fn<cast_signed>} ins(%186, %188 : tensor<1024x8960xf32>, tensor<8960x1536xf32>) outs(%cst_54 : tensor<1024x1536xf32>) -> tensor<1024x1536xf32>
  ...
  %211 = linalg.matmul ins(%205, %208 : tensor<1024x1536xf32>, tensor<1536x1536xf32>) outs(%cst_55 : tensor<1024x1536xf32>) -> tensor<1024x1536xf32>
...
func.func @main() {
  ...
  %res = call @kernel(%c0, %c1, %c2, %c3, %c4, %c5) : (tensor<8960x1536xf32>, tensor<1024x1536xf32>, tensor<8960x1536xf32>, tensor<1536x8960xf32>, tensor<1536xf32>, tensor<1536x1536xf32>) -> tensor<1024x1536xf32>
