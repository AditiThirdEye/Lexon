...
func.func @kernel(%arg0: tensor<1x1536xf32>, %arg1: tensor<1536x8960xf32>, %arg2: tensor<1x1x1536xf32>, %arg3: tensor<1536x8960xf32>, %arg4: tensor<8960x1536xf32>, %arg5: tensor<1x1x1536xf32>) -> tensor<1x1x1536xf32> {
  ...
  %274 = tosa.reshape %273 {new_shape = array<i64: 1, 1, 8960>} : (tensor<1x8960xf32>) -> tensor<1x1x8960xf32>
  %275 = tosa.sigmoid %274 : (tensor<1x1x8960xf32>) -> tensor<1x1x8960xf32>
  %276 = tosa.mul %274, %275 : (tensor<1x1x8960xf32>, tensor<1x1x8960xf32>) -> tensor<1x1x8960xf32>
  %277 = tosa.reshape %arg2 {new_shape = array<i64: 1, 1536>} : (tensor<1x1x1536xf32>) -> tensor<1x1536xf32>
  ...
  %279 = tosa.reshape %278 {new_shape = array<i64: 1, 1, 8960>} : (tensor<1x8960xf32>) -> tensor<1x1x8960xf32>
  %280 = tosa.mul %276, %279 : (tensor<1x1x8960xf32>, tensor<1x1x8960xf32>) -> tensor<1x1x8960xf32>
  %281 = tosa.reshape %280 {new_shape = array<i64: 1, 8960>} : (tensor<1x1x8960xf32>) -> tensor<1x8960xf32>
  ...
  %283 = tosa.reshape %282 {new_shape = array<i64: 1, 1, 1536>} : (tensor<1x1536xf32>) -> tensor<1x1x1536xf32>
