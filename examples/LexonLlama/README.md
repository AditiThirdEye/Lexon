...
```
$ cmake -G Ninja .. -DLEXON_LLAMA_EXAMPLES=ON
$ ninja lexon-llama-run
$ cd bin
$ ./lexon-llama-run
```
This build will spend a few minutes. We recommend you to use better cpu such as server-level cpu to run lexon-llama-run.
