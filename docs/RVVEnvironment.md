...
This guide provides instructions on setting up an environment to test the RISC-V Vector Extension using the lexon-mlir project.
...
0. Prepare `lexon-mlir` and Submodules

```
$ git clone https://github.com/lexon-compiler/lexon-mlir.git
$ cd lexon-mlir
...
$ cmake -G Ninja .. \
    ...
    -DLLVM_ENABLE_ASSERTIONS=ON \
    -DCMAKE_BUILD_TYPE=RELEASE \
    -DLEXON_MLIR_ENABLE_RISCV_GNU_TOOLCHAIN=ON \
...
5. Build Cross-Compiled `lexon-mlir`
