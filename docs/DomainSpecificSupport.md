...
The lexon compiler is a domain-specific compiler infrastructure. We intend to build an ecosystem of domain-specifc applications. This document shows how we support the existing domain frameworks.
